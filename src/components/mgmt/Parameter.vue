...
<template>
  <div class="col-6 text-center">
    <div class="p-3 border bg-body rounded-3">
      ...
      >
        <span class="h5">{{ parameter.name }}</span
        ...
        <div class="col-9">
          <div class="input-group">
            <Field
              ...
              @change="(value) => updateParameter('description', value)"
              label="description"
            />
          </div>
        </div>
        ...
        <div class="col-9">
          <div class="input-group">
            <Field
              ...
              @change="(value) => updateParameter('defaultValue', value)"
              label="default value"
            />
          </div>
        </div>
          ...
          <div class="col-9">
            <div class="input-group">
              <Field
                ...
                @change="(value) => updateParameter('minValue', value)"
                label="min value"
              />
            </div>
          </div>
          ...
          <div class="col-9">
            <div class="input-group">
              <Field
                ...
                @change="(value) => updateParameter('maxValue', value)"
                label="max value"
              />
            </div>
          </div>
        ...
        <div class="row align-items-center text-start mt-1">
          ...
          <div class="col-9">
            <div class="input-group">
              <Field
                :editable="true"
                :value="parameter.pressValue"
                @change="(value) => updateParameter('pressValue', value)"
                label="press value"
              />
            </div>
          </div>
          ...
          <div class="col-12 mt-1" v-for="value in parameter.values" :key="value.value">
            <div class="input-group">
              <Field
                ...
                label="Description"
                @change="(desc) => updateParameterDescription(value, desc)"
              />
              <Field :value="value.value" label="Value" />
              <button
                type="button"
                class="btn btn-outline-danger"
                @click="() => deleteParameterValue(parameter.parameterId, value.value)"
              >
                Delete
              </button>
            </div>
      ...
      <div class="collapse" :id="`parameterImage${parameter.parameterId}`">
        ...
        <div class="input-group mb-2 mt-2">
          <ImageInput
            ...
            :idValue="parameter.parameterId"
            @image-changed="() => $emit('parameter-changed')"
          />
        </div>
        <div>
          Note: The image will be scaled to have a maximum width/height of 128, preserving aspect
          ratio.
        </div>
      </div>
      <div class="row mt-3">
        ...
        <div class="col-6 text-end">
          <button
            ...
            :data-bs-target="`#deleteParameter-confirm${parameter.parameterId}`"
          >
            Delete Parameter
          </button>
        </div>
      ...
      <div
        :id="`deleteParameter-confirm${parameter.parameterId}`"
        class="modal fade"
        tabindex="-1"
        aria-hidden="true"
      >
