...
function updateAvatarChangeCooldown(value: string) {
    ...
    if (isNaN(state.settings.avatarChangeCooldown) || !Number.isInteger(state.settings.avatarChangeCooldown)) {
        ...
        <div class="row align-items-center text-start mt-1">
            ...
            <div class="col-6">
                <div class="input-group">
                    <Field :editable="true" :value="state.settings?.avatarChangeCooldown" @change="updateAvatarChangeCooldown" />
                </div>
            </div>
        </div>
        <div class="row align-items-center text-start mt-1">
            ...
            <div class="col-6">
                <div class="input-group">
                    <Field :editable="true" :value="state.settings?.colorPrimary" @change="updatePrimaryColor" />
                </div>
            </div>
        </div>
    </div>
